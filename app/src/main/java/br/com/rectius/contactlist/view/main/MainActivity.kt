...
import br.com.rectius.contactlist.view.formulario.FormularioActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun registerObservers() {
        ...
        mainViewModel.contacts.observe(this, contactsObserver)
    }

    private var contactsObserver = Observer<List<Contact>> {
        rvContacts.adapter = MainListAdapter(
            this,
            it!!
        ) {
